...
public class Club extends BaseEntity {
    ...
    public String getIsRecruiting() { return isRecruiting; }
    public void setIsRecruiting(String isRecruiting) { this.isRecruiting = isRecruiting; }
    public String getIsPopular() { return isPopular; }
    public void setIsPopular(String isPopular) { this.isPopular = isPopular; }
